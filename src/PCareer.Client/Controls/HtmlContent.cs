...
.logo{width:44px;height:44px;border-radius:12px;position:relative;flex-shrink:0;
  background:radial-gradient(circle at 50% 50%,rgba(99,102,241,0.15),rgba(99,102,241,0.04));
  border:1px solid rgba(99,102,241,0.18);
  display:grid;place-items:center}
.logo-inner{font-size:15px;font-weight:700;color:var(--indigo2);letter-spacing:0.02em}
...
<div class="row">
  <div class="panel">
    <div class="field-label">Discord account</div>
