...
$outputDirectory = [System.IO.Path]::GetFullPath(
    (Join-Path $projectRoot "dist\PCareer.Client-development"))
...
if ($Version) {
    ...
    Write-Host "Building single-file development client v$Version with SimConnect support..." -ForegroundColor Green
} else {
    Write-Host "Building single-file development client with SimConnect support..." -ForegroundColor Green
}
...
Write-Host "Development client built successfully as one file:" -ForegroundColor Green
